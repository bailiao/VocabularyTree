...
enum feature_type
{
	FEATURE_OXFD,						//FEATURE_OXFD表示牛津大学VGG提供的源码中的特征点格式
	FEATURE_LOWE,						//FEATURE_LOWE表示David.Lowe提供的源码中的特征点格式
};

/** FEATURE_FWD_MATCH <BR> FEATURE_BCK_MATCH <BR> FEATURE_MDL_MATCH */
enum feature_match_type
{
	FEATURE_FWD_MATCH,		//matching feature from forward image
	FEATURE_BCK_MATCH,		//matching feature from backmward image
	FEATURE_MDL_MATCH,		//matching feature from model
};
...
struct feature
{
	...
	int lap;						//added by mrQian: for light or dark point
};
